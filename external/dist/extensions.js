...
var SRC_PATH = "src";
var DIST_PATH = "dist";
var BUNDLE_FILE_NAME = "fifx-client.js";
...
let AgGrid$1 = class AgGrid {
    static preBuild() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield fs__namespace.mkdir(`${constants.PROJECT_PATH}/dev-tools/extensions/ag-grid`, { recursive: true });
                yield fs__namespace.copyFile(`${constants.DEV_TOOLS_PATH}/extensions/ag-grid/external/ag-grid-community-layer.tsx`, `${constants.PROJECT_PATH}/dev-tools/extensions/ag-grid/ag-grid-community-layer.tsx`);
            }
            catch (e) {
...
AgGrid$1.webpackConfig = webpackConfig$1;
...
class AgGrid {
    static preBuild() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let content = yield fs__namespace.readFile(`${constants.DEV_TOOLS_PATH}/extensions/icap-register-with-redux/external/reexport-template.ts`, { encoding: 'utf8' });
                content = content.replaceAll('%PROJECT_PATH%', constants.PROJECT_PATH);
                yield fs__namespace.writeFile(`${constants.DEV_TOOLS_PATH}/extensions/icap-register-with-redux/external/reexport.ts`, content);
            }
            catch (e) {
...
AgGrid.webpackConfig = webpackConfig;

var external = {
    middlewares: compose(applyMiddleware(MessageStorage.middleware)),
    webpackConfig: [AgGrid$1.webpackConfig, AgGrid.webpackConfig],
    preBuild: [AgGrid$1.preBuild, AgGrid.preBuild],
