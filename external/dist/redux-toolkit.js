...
var objectSpread2$1 = {exports: {}};

var defineProperty$1 = {exports: {}};

var toPropertyKey$2 = {exports: {}};
...
var toPrimitiveExports$1 = toPrimitive$2.exports;

(function (module) {
	var _typeof = _typeofExports$1["default"];
	var toPrimitive = toPrimitiveExports$1;
...
var toPropertyKeyExports$1 = toPropertyKey$2.exports;

(function (module) {
	var toPropertyKey = toPropertyKeyExports$1;
...
var definePropertyExports$1 = defineProperty$1.exports;

(function (module) {
	var defineProperty = definePropertyExports$1;
...
var objectSpread2Exports$1 = objectSpread2$1.exports;

Object.defineProperty(redux$1, '__esModule', { value: true });

var _objectSpread$1 = objectSpread2Exports$1;

function _interopDefaultLegacy$1 (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var _objectSpread__default$1 = /*#__PURE__*/_interopDefaultLegacy$1(_objectSpread$1);
 ...
 */
var randomString$2 = function randomString() {
  return Math.random().toString(36).substring(7).split('').join('.');
};

var ActionTypes$1 = {
  INIT: "@@redux/INIT" + randomString$2(),
  REPLACE: "@@redux/REPLACE" + randomString$2(),
  PROBE_UNKNOWN_ACTION: function PROBE_UNKNOWN_ACTION() {
    return "@@redux/PROBE_UNKNOWN_ACTION" + randomString$2();
  }
};
...
function createStore$2(reducer, preloadedState, enhancer) {
  ...
  if (typeof preloadedState === 'function' && typeof enhancer === 'function' || typeof enhancer === 'function' && typeof arguments[3] === 'function') {
    throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(0) : 'It looks like you are passing several store enhancers to ' + 'createStore(). This is not supported. Instead, compose them ' + 'together to a single function. See https://redux.js.org/tutorials/fundamentals/part-4-store#creating-a-store-with-enhancers for an example.');
  }
  ...
  if (typeof enhancer !== 'undefined') {
    if (typeof enhancer !== 'function') {
      throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(1) : "Expected the enhancer to be a function. Instead, received: '" + kindOf$1(enhancer) + "'");
    }
  ...
  if (typeof reducer !== 'function') {
    throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(2) : "Expected the root reducer to be a function. Instead, received: '" + kindOf$1(reducer) + "'");
  }
  ...
  function getState() {
    if (isDispatching) {
      throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(3) : 'You may not call store.getState() while the reducer is executing. ' + 'The reducer has already received the state as an argument. ' + 'Pass it down from the top reducer instead of reading it from the store.');
    }
  ...
  function subscribe(listener) {
    if (typeof listener !== 'function') {
      throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(4) : "Expected the listener to be a function. Instead, received: '" + kindOf$1(listener) + "'");
    }

    if (isDispatching) {
      throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(5) : 'You may not call store.subscribe() while the reducer is executing. ' + 'If you would like to be notified after the store has been updated, subscribe from a ' + 'component and invoke store.getState() in the callback to access the latest state. ' + 'See https://redux.js.org/api/store#subscribelistener for more details.');
    }
    ...
    return function unsubscribe() {
      ...
      if (isDispatching) {
        throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(6) : 'You may not unsubscribe from a store listener while the reducer is executing. ' + 'See https://redux.js.org/api/store#subscribelistener for more details.');
      }
  ...
  function dispatch(action) {
    if (!isPlainObject$1(action)) {
      throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(7) : "Actions must be plain objects. Instead, the actual type was: '" + kindOf$1(action) + "'. You may need to add middleware to your store setup to handle dispatching other values, such as 'redux-thunk' to handle dispatching functions. See https://redux.js.org/tutorials/fundamentals/part-4-store#middleware and https://redux.js.org/tutorials/fundamentals/part-6-async-logic#using-the-redux-thunk-middleware for examples.");
    }

    if (typeof action.type === 'undefined') {
      throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(8) : 'Actions may not have an undefined "type" property. You may have misspelled an action type string constant.');
    }

    if (isDispatching) {
      throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(9) : 'Reducers may not dispatch actions.');
    }
  ...
  function replaceReducer(nextReducer) {
    if (typeof nextReducer !== 'function') {
      throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(10) : "Expected the nextReducer to be a function. Instead, received: '" + kindOf$1(nextReducer));
    }
    ...
    return _ref = {
      ...
      subscribe: function subscribe(observer) {
        if (typeof observer !== 'object' || observer === null) {
          throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(11) : "Expected the observer to be an object. Instead, received: '" + kindOf$1(observer) + "'");
        }
...
var legacy_createStore$1 = createStore$2;
...
function assertReducerShape$1(reducers) {
  Object.keys(reducers).forEach(function (key) {
    ...
    if (typeof initialState === 'undefined') {
      throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(12) : "The slice reducer for key \"" + key + "\" returned undefined during initialization. " + "If the state passed to the reducer is undefined, you must " + "explicitly return the initial state. The initial state may " + "not be undefined. If you don't want to set a value for this reducer, " + "you can use null instead of undefined.");
    }

    if (typeof reducer(undefined, {
      type: ActionTypes$1.PROBE_UNKNOWN_ACTION()
    }) === 'undefined') {
      throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(13) : "The slice reducer for key \"" + key + "\" returned undefined when probed with a random type. " + ("Don't try to handle '" + ActionTypes$1.INIT + "' or other actions in \"redux/*\" ") + "namespace. They are considered private. Instead, you must return the " + "current state for any unknown actions, unless it is undefined, " + "in which case you must return the initial state, regardless of the " + "action type. The initial state may not be undefined, but can be null.");
    }
  });
}
/**
...
function combineReducers$2(reducers) {
  var reducerKeys = Object.keys(reducers);
  var finalReducers = {};
  ...
  return function combination(state, action) {
    ...
    for (var _i = 0; _i < finalReducerKeys.length; _i++) {
      ...
      if (typeof nextStateForKey === 'undefined') {
        ...
        throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(14) : "When called with an action of type " + (actionType ? "\"" + String(actionType) + "\"" : '(unknown type)') + ", the slice reducer for key \"" + _key + "\" returned undefined. " + "To ignore an action, you must explicitly return the previous state. " + "If you want this reducer to hold no value, you can return null instead of undefined.");
      }
...
function bindActionCreators$2(actionCreators, dispatch) {
  if (typeof actionCreators === 'function') {
    return bindActionCreator$1(actionCreators, dispatch);
  }

  if (typeof actionCreators !== 'object' || actionCreators === null) {
    throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(16) : "bindActionCreators expected an object or a function, but instead received: '" + kindOf$1(actionCreators) + "'. " + "Did you write \"import ActionCreators from\" instead of \"import * as ActionCreators from\"?");
  }
  ...
  return function (createStore) {
    return function () {
      ...
      var _dispatch = function dispatch() {
        throw new Error(process.env.NODE_ENV === "production" ? formatProdErrorMessage$2(15) : 'Dispatching while constructing your middleware is not allowed. ' + 'Other middleware would not be applied to this dispatch.');
      };
      ...
      _dispatch = compose$4.apply(void 0, chain)(store.dispatch);
      return _objectSpread__default$1['default'](_objectSpread__default$1['default']({}, store), {}, {
        dispatch: _dispatch
      });
    };
  };
...
function isCrushed$2() {}

if (process.env.NODE_ENV !== 'production' && typeof isCrushed$2.name === 'string' && isCrushed$2.name !== 'isCrushed') {
...
redux$1.__DO_NOT_USE__ActionTypes = ActionTypes$1;
var applyMiddleware_1$1 = redux$1.applyMiddleware = applyMiddleware$4;
var bindActionCreators_1 = redux$1.bindActionCreators = bindActionCreators$2;
var combineReducers_1 = redux$1.combineReducers = combineReducers$2;
var compose_1$1 = redux$1.compose = compose$4;
var createStore_1 = redux$1.createStore = createStore$2;
redux$1.legacy_createStore = legacy_createStore$1;
...
function _arrayFromIterator$2(iter) {
  var list = [];
  var next;
...
function _includesWith$2(pred, x, list) {
  var idx = 0;
  var len = list.length;
...
var _objectIs$5 = typeof Object.is === 'function' ? Object.is : _objectIs$4;
...
var nonEnumerableProps$2 = ['constructor', 'valueOf', 'isPrototypeOf', 'toString', 'propertyIsEnumerable', 'hasOwnProperty', 'toLocaleString']; // Safari bug

var hasArgsEnumBug$2 =
/*#__PURE__*/
function () {
...
var keys$2 = typeof Object.keys === 'function' && !hasArgsEnumBug$2 ?
/*#__PURE__*/
...
_curry1$2(function keys(obj) {
  ...
  var checkArgsLength = hasArgsEnumBug$2 && _isArguments$2(obj);
  ...
  if (hasEnumBug$2) {
    nIdx = nonEnumerableProps$2.length - 1;

    while (nIdx >= 0) {
      prop = nonEnumerableProps$2[nIdx];

      if (_has$2(prop, obj) && !contains$2(ks, prop)) {
        ks[ks.length] = prop;
      }
...
function _uniqContentEquals$2(aIterator, bIterator, stackA, stackB) {
  var a = _arrayFromIterator$2(aIterator);

  var b = _arrayFromIterator$2(bIterator);

  function eq(_a, _b) {
    return _equals$2(_a, _b, stackA.slice(), stackB.slice());
  } // if *a* array contains any element that is not included in *b*


  return !_includesWith$2(function (b, aItem) {
    return !_includesWith$2(eq, aItem, b);
  }, b, a);
}

function _equals$2(a, b, stackA, stackB) {
  if (_objectIs$5(a, b)) {
    return true;
  }
  ...
  switch (typeA) {
    ...
    case 'Array':
    case 'Object':
      if (typeof a.constructor === 'function' && _functionName$2(a.constructor) === 'Promise') {
        return a === b;
      }
    ...
    case 'Number':
    case 'String':
      if (!(typeof a === typeof b && _objectIs$5(a.valueOf(), b.valueOf()))) {
        return false;
      }
    ...
    case 'Date':
      if (!_objectIs$5(a.valueOf(), b.valueOf())) {
        return false;
      }
  ...
  switch (typeA) {
    case 'Map':
      ...
      return _uniqContentEquals$2(a.entries(), b.entries(), stackA.concat([a]), stackB.concat([b]));
    ...
    case 'Set':
      ...
      return _uniqContentEquals$2(a.values(), b.values(), stackA.concat([a]), stackB.concat([b]));
  ...
  while (idx >= 0) {
    ...
    if (!(_has$2(key, b) && _equals$2(b[key], a[key], extendedStackA, extendedStackB))) {
      return false;
    }
...
var equals$2 =
/*#__PURE__*/
_curry2$2(function equals(a, b) {
  return _equals$2(a, b, [], []);
});
...
var _isArrayLike =
/*#__PURE__*/
_curry1$2(function isArrayLike(x) {
  if (_isArray$2(x)) {
    return true;
  }
...
var bind =
/*#__PURE__*/
_curry2$2(function bind(fn, thisObj) {
...
function _assoc(prop, val, obj) {
  if (_isInteger(prop) && _isArray$2(obj)) {
    var arr = [].concat(obj);
    arr[prop] = val;
    return arr;
  }
...
var empty$2 =
/*#__PURE__*/
_curry1$2(function empty(x) {
  return x != null && typeof x['fantasy-land/empty'] === 'function' ? x['fantasy-land/empty']() : x != null && x.constructor != null && typeof x.constructor['fantasy-land/empty'] === 'function' ? x.constructor['fantasy-land/empty']() : x != null && typeof x.empty === 'function' ? x.empty() : x != null && x.constructor != null && typeof x.constructor.empty === 'function' ? x.constructor.empty() : _isArray$2(x) ? [] : _isString$2(x) ? '' : _isObject$2(x) ? {} : _isArguments$2(x) ? function () {
    return arguments;
  }() : _isTypedArray$2(x) ? x.constructor.from('') : void 0 // else
  ;
});
...
_curry3(function modifyPath(path, fn, object) {
  if (!_isObject$2(object) && !_isArray$2(object)) {
    return object;
  }
...
const getActionByType = (type, { shift = 0, payload = {} } = {}) => {
    ...
    if (!typeActions || isEmpty$2(typeActions)) {
        return;
    }
    ...
    return Object.assign(Object.assign({}, action), { payload: Object.assign({}, action.payload, payload) });
};
...
function devToolsMiddleware () {
    ...
    return function (next) {
        return function (action) {
            if (window === null || window === void 0 ? void 0 : window.disabledActions) {
                if (any((disabledAction) => {
                    var _a;
                    return (((_a = action.type) === null || _a === void 0 ? void 0 : _a.includes(disabledAction.type)) &&
                        (isNil$2(disabledAction.exception) || !objectsMatch(disabledAction === null || disabledAction === void 0 ? void 0 : disabledAction.exception, action.payload)));
                })(window === null || window === void 0 ? void 0 : window.disabledActions)) {
                    return;
                }
            }
            const newAction = Object.assign({ id: id++ }, action);
            addAction(newAction);
...
var enhancedReducer = (appReducer) => (...args) => {
    var _a;
    if (values(ACTION_TYPES).includes((_a = args === null || args === void 0 ? void 0 : args[1]) === null || _a === void 0 ? void 0 : _a.type)) {
        return devToolsReducer(args === null || args === void 0 ? void 0 : args[0], args === null || args === void 0 ? void 0 : args[1]);
    }
    return appReducer(args === null || args === void 0 ? void 0 : args[0], args === null || args === void 0 ? void 0 : args[1]);
};
...
var devToolsStore = (store) => (Object.assign(Object.assign({}, store), { replaceReducer: (arg) => {
    ...
    get state2() { return store.getState(); }, panelState: (panelType) => {
        if (!panelType) {
            return undefined;
        }
        return pipe(prop('panels'), (panels) => {
            const panelTypes = keys$2(panels);
    ...
    }, getActions: getActions, redispatch: (type, options = {}) => {
    ...
    }, disableAction: ({ type, exception }) => {
        if (window.disabledActions) {
            setVar('disabledActions', [...window.disabledActions, { type, exception }]);
        }
        else {
        ...
        if (window.disabledActions) {
            setVar('disabledActions', window.disabledActions.filter((existingAction) => !existingAction.type.includes(type) && !type.includes(existingAction.type)));
        }
    }, enableActions: () => {
        setVar('disabledActions', []);
    }, setField: (path, value) => {
        const state = store.getState();
        const pathArr = String(path).split('.').map(segment => isNaN(segment) ? segment : Number(segment));
        store.dispatch(setState(modifyPath(pathArr, () => value, state)));
    }, setPanelField: (panelType, path, value) => {
        const panelPath = pipe(prop('panels'), (panels) => (pipe(keys$2, find((existingPanelType) => existingPanelType.toLowerCase().includes(panelType.toLowerCase())), (existingPanelType) => {
            if (!existingPanelType) {
                return '';
            }
            const panel = panels[existingPanelType];
            const panelIds = keys$2(panel);
...
var _objectSpread = objectSpread2Exports;
...
redux.__DO_NOT_USE__ActionTypes = ActionTypes;
var applyMiddleware_1 = redux.applyMiddleware = applyMiddleware$2;
redux.bindActionCreators = bindActionCreators$1;
redux.combineReducers = combineReducers$1;
var compose_1 = redux.compose = compose$2;
redux.createStore = createStore$1;
redux.legacy_createStore = legacy_createStore;
...
_curry1$1(function empty(x) {
  return x != null && typeof x['fantasy-land/empty'] === 'function' ? x['fantasy-land/empty']() : x != null && x.constructor != null && typeof x.constructor['fantasy-land/empty'] === 'function' ? x.constructor['fantasy-land/empty']() : x != null && typeof x.empty === 'function' ? x.empty() : x != null && x.constructor != null && typeof x.constructor.empty === 'function' ? x.constructor.empty() : _isArray$1(x) ? [] : _isString$1(x) ? '' : _isObject$1(x) ? {} : _isArguments$1(x) ? function () {
    return arguments;
  }() : _isTypedArray$1(x) ? x.constructor.from('') : void 0 // else
  ;
});
...
var storage$1 = new Storage$1();

let MessageStorage$1 = class MessageStorage {
    static log(message) {
        return storage$1.log(MessageStorage.key, message);
    }
    static get(criteria) {
        return storage$1.get(MessageStorage.key, criteria);
    }
    static middleware() {
        return function (next) {
            return function (action) {
                var _a;
                if ((_a = action === null || action === void 0 ? void 0 : action.type) === null || _a === void 0 ? void 0 : _a.includes(MessageStorage.pattern)) {
...
MessageStorage$1.key = 'messages';
MessageStorage$1.pattern = 'SUBSCRIPTION/MESSAGE';

({
    middlewares: compose$1(applyMiddleware$1(MessageStorage$1.middleware))
});

const applyMiddleware$3 = applyMiddleware_1;
const compose$3 = compose_1;

class Storage {
    constructor() {
        this.log = (logsKey, value) => {
            return fetch(`http://localhost:${SERVER_PORT$1}/storage/log/${encodeURIComponent(`${logsKey}`)}`, {
                method: 'POST',
                body: JSON.stringify(value),
                headers: {
                    'Content-Type': 'application/json',
                ...
                if (!isNil$1(result) && !isEmpty$1(result)) {
                    return result.json();
                }
                return null;
            }).then(result => {
        ...
        this.clear = (key) => {
            return fetch(`http://localhost:${SERVER_PORT$1}/storage/clear/${encodeURIComponent(`${key}`)}`)
                .then(result => {
                if (!isNil$1(result) && !isEmpty$1(result)) {
                    return result.json();
                }
        ...
        this.get = (logsKey, criteria) => {
            return fetch(`http://localhost:${SERVER_PORT$1}/storage/get/${encodeURIComponent(`${logsKey}`)}/${encodeURIComponent(`${JSON.stringify(criteria)}`)}`).then(result => {
                if (!isNil$1(result) && !isEmpty$1(result)) {
                    return result.json();
                }
                return null;
...
MessageStorage.key = 'messages';
MessageStorage.pattern = 'SUBSCRIPTION/MESSAGE';

var external = {
    middlewares: compose$3(applyMiddleware$3(MessageStorage.middleware))
};

var extensions = external;


var extensions$1 = /*@__PURE__*/getDefaultExportFromCjs(extensions);

const applyMiddleware = applyMiddleware_1$1;
const combineReducers = combineReducers_1;
const bindActionCreators = bindActionCreators_1;
const compose = compose_1$1;
const createStore = function (reducer, initialState, enhancers) {
    if (window.store) {
        return createStore_1(reducer, initialState, enhancers);
    }
    let store = createStore_1(enhancedReducer(reducer), initialState, compose_1$1(enhancers, applyMiddleware_1$1(devToolsMiddleware), extensions$1.middlewares));
...
//# sourceMappingURL=redux-toolkit.js.map
