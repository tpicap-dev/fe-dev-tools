...
var applyMiddleware_1 = redux.applyMiddleware = applyMiddleware$1;
var bindActionCreators_1 = redux.bindActionCreators = bindActionCreators$1;
var combineReducers_1 = redux.combineReducers = combineReducers$1;
var compose_1 = redux.compose = compose$1;
var createStore_1 = redux.createStore = createStore$1;
            ...
            if (window === null || window === void 0 ? void 0 : window.disabledActions) {
                if (any((disabledAction) => {
                    ...
                    return (((_a = action.type) === null || _a === void 0 ? void 0 : _a.includes(disabledAction.type)) &&
                        (isNil(disabledAction.exception) || !objectsMatch(disabledAction === null || disabledAction === void 0 ? void 0 : disabledAction.exception, action.payload)));
...
var devToolsStore = (store) => (Object.assign(Object.assign({}, store), { replaceReducer: (arg) => {
    ...
    }, state() { return store.getState(); }, panelState: (panelType) => {
        if (!panelType) {
            return undefined;
        }
        ...
        const panelPath = pipe(prop('panels'), (panels) => (pipe(keys, find((existingPanelType) => existingPanelType.toLowerCase().includes(panelType.toLowerCase())), (existingPanelType) => {
...
const createStore = function (reducer, initialState, enhancers) {
    ...
    let store = createStore_1(enhancedReducer(reducer), initialState, compose_1(enhancers, applyMiddleware_1(devToolsMiddleware)));
