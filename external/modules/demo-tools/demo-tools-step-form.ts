...
import { IStep, IElementBoundStep, IHighlightingStep, IInputBoundStep } from './demo'
import './style.less'
...
export default abstract class StepForm {
  ...
  static getFormValues() {
    return {
      ...
      value: (document.getElementById('demo-tools-step-picker-form-type') as HTMLInputElement).value === 'setValye' ?
  ...
  static getForm(values?: Partial<IElementBoundStep>): string {
    ...
    return `
      <div class="demo-tools" id="demo-tools-step-picker-form">
        ...
        <div class="demo-tools-step-picker-form-control"><input type="number" id="demo-tools-step-picker-form-interval" value="${values?.interval}" step="100" />&nbsp;ms</div>
